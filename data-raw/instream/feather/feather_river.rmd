...
The following plot shows the weighted usable rearing area in square feet per thousand feet of river for Fall Run Chinook Salmon fry and juvenile (FR_fry_wua and FR_juv_wua). These rates are multiplied by the total rearing reach length mapped by the SIT and applied for the flow in each month in the DSM.
