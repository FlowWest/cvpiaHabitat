...
The instream spawning and rearing habitat data described below for Fall Run Chinook Salmon (FR) and Steelhead (ST) is combined for use in the DSM in the following format. 
