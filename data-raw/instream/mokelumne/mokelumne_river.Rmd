...
**Data Sources:** EBMUD 2016 and [CDFW 1991](https://s3-us-west-2.amazonaws.com/cvpiahabitat-r-package/cvpia-sit-model-inputs/Lower_Mokelumne_River_Fisheries_Study_Draft%2C_June_1988-In_Dox.pdf)
...
The instream spawning and rearing habitat data described above is combined for use in the DSM using the following code. 
