...
author: "Sadie Gill, Mark Tompkins"
...
TODO narrate plot or remove it.
...
TODO narrate plots or remove them.
...
400 cfs = 0 acres TODO
Using same flow to area relation for all runs. TODO
Prepare data in proper form to be used in habitat setting functions. 


```{r}
# floodplain: 'LMR_habitat__s_v2mw_to_MT.xlsx', 'Floodplain (new flows)' tab C21:D26 Camanche to tidal low estimate, 400 cfs = 0 total acres
