...
Instream spawning and rearing habitat for Fall Run Chinook Salmon and Steelhead in the Bear River are based on data from an instream flow study from the South Sutter Water District. SSWD performed this study using River2D, a 2-dimensional hydraulic and habitat model. SSWD used this model at 2 sites to find spawning and rearing availability data, which the FWS then collected at a third site to ultimately obtain data for 3 separate reaches. The instream spawning and rearing habitat data were provided to us by [Mark Gard](mailto:mark_gard@fws.gov) from the U.S. Fish and Wildlife Service. We compiled it into a [spreadsheet](https://cvpiahabitat-r-package.s3-us-west-2.amazonaws.com/updated_bear_river_instream.csv) and combined the three reaches, which were scaled by length, and converted into sqft/1000 ft.  
