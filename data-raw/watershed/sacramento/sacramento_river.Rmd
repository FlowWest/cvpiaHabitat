...
```{r}
knitr::kable(align = 'c', head(upper_sac_ACID_boards_in, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_spawn_wua = Fall Run Chinook Spawning wua, LFR_spawning_wua = Late Fall Run Chinook Spawning wua, ST_spawn_wua = Steelhead Spawning wua, WR_spawn_wua = Winter Run Chinook Spawning wua")
```
...
```{r}
knitr::kable(align = 'c', head(upper_sac_ACID_boards_out, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_spawn_wua = Fall Run Chinook Spawning wua, LFR_spawning_wua = Late Fall Run Chinook Spawning wua, ST_spawn_wua = Steelhead Spawning wua, WR_spawn_wua = Winter Run Chinook Spawning wua")
```
...
knitr::kable(align = 'c', head(upper_sacramento_river_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, rearing_sq_meters = Rearing Square Meters")
...
knitr::kable(align = 'c', head(upper_mid_sacramento_river_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, rearing_sq_meters = Rearing Square Meters")
```
...
knitr::kable(align = 'c', head(lower_mid_sacramento_river_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, rearing_sq_meters = Rearing Square Meters")
```
...
knitr::kable(align = 'c', head(lower_sacramento_river_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, rearing_sq_meters = Rearing Square Meters")
```
...
**Data Source:** Central Valley Floodplain Evaluation and Delineation (CVFED) HEC-RAS hydraulic model refined for use in the [NOAA-NMFS Winter Run Chinook Salmon life cycle model](https://s3-us-west-2.amazonaws.com/cvpiahabitat-r-package/cvpia-sit-model-inputs/HendrixEtAl2014_Winter_Run_Model_Tech_Memo.pdf){target="_blank"}
...
### Upper Sacramento River    
The CVPIA Upper Sacramento River reach is 59.28 miles, 28.92 of those miles are in the NOAA NMFS study's first reach and the rest are in the second reach. We have summed the proportion of area by length in second reach to total in first. 
```{r}
upper_sac_above_battle <- 28.92
upper_sac_below_battle <- 59.28 - upper_sac_above_battle
prop_bat_rbdd <- upper_sac_below_battle / reach_miles['bat_feat']
...
knitr::kable(align = 'c', head(upper_sacramento_river_floodplain, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, floodplain_sq_meters = Floodplain Square Meters")
...
knitr::kable(align = 'c', head(upper_mid_sacramento_river_floodplain, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, floodplain_sq_meters = Floodplain Square Meters")
...
### Lower-mid Sacramento River    
The CVPIA Lower-mid Sacramento River reach is 57.96 miles, 33.89 of those miles are in the NOAA NMFS study's second reach and the rest are in the third reach. We have summed the proportion of area by length in second reach to total in first. 
```{r}
wilk_amer_mi <- 57.96
wilk_feather_mi <- reach_miles['bat_feat'] - rbdd_wilk_mi - upper_sac_below_battle
prop_wilkins_feather <- wilk_feather_mi / reach_miles['bat_feat']
...
knitr::kable(align = 'c', head(lower_mid_sacramento_river_floodplain, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, floodplain_sq_meters = Floodplain Square Meters")
...
knitr::kable(align = 'c', head(lower_sacramento_river_floodplain, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, floodplain_sq_meters = Floodplain Square Meters")
