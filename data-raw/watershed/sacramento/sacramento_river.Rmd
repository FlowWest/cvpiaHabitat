...
combined_floodplain_rearing <- (upper_sacramento_river_floodplain %>% 
                       rename(upper_floodplain_sqm = floodplain_sq_meters)) %>% 
  bind_cols((upper_mid_sacramento_river_floodplain %>% 
                       rename(upper_mid_floodplain_sqm = floodplain_sq_meters)), 
            (lower_mid_sacramento_river_floodplain %>% 
                       rename(lower_mid_floodplain_sqm = floodplain_sq_meters))) %>% 
  mutate(watershed = 'Sacramento River') %>% 
  select(flow_cfs, upper_floodplain_sqm, upper_mid_floodplain_sqm, 
         lower_mid_floodplain_sqm, watershed)
