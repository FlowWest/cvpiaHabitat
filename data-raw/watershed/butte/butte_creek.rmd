...
knitr::kable(align = 'c', head(butte_creek_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_spawn_wua = Fall Run Chinook Spawning wua,  FR_juv_wua = Fall Run Chinook Juvenile wua,  FR_fry_wua = Fall Run Chinook Fry wua" )
