...
Instream spawning and rearing habitat for Fall Run Chinook Salmon in Butte Creek are based on data from the FWS instream 2003 study and the FERC relicensing of DeSabla 2008 study. The spawning habitat data are from the FWS study (p. 77-78) and was collected using a RIVER2D 2-dimensional hydraulic and habitat model. The rearing data come from DeSabla 2008 in the lower butte section of the appendix (APPENDIX E6.3.2.6-J1). Instream rearing habitat data were provided in a [spreadsheet](https://cvpiahabitat-r-package.s3-us-west-2.amazonaws.com/IFIMWUA.xlsx). Mark Gard instructed us to use cells A71:C101 for the Fall Run Chinook rearing data. The spawning data were compiled in a [spreadsheet](https://cvpiahabitat-r-package.s3-us-west-2.amazonaws.com/butte_creek_data.csv). The spawning data were then scaled by reach length. There were no Fall Fun Chinook Salmon or Steelhead Spawning data collected, and hence the Spring Run Chinook Salmon Spawning data are used as a proxy for Fall Run Chinook Salmon Spawning. Units are in square feet per 1000 feet.
