...
The instream spawning and rearing habitat data described above is combined for use in the DSM in the following format. Units are in square feet per 1000 feet of river.
```{r}
...
### Spawning WUA   
The following plot shows the weighted usable spawning area rate in square feet per thousand feet of river for Fall Run Chinook Salmon (FR). 
```{r, echo=FALSE}
spawning_moke %>% 
