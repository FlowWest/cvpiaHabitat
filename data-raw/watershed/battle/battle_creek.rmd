...
knitr:: kable(head(battle_creek_instream, 5), align = 'c', caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_spawn_wua = Fall Run Chinook Spawning wua,  FR_fry_wua = Fall Run Chinook Fry wua, FR_juv_wua = Fall Run Chinook Juvenile wua, ST_adult_wua = Steelhead Adult wua, ST_spawn_wua = Steelhead Spawning wua, ST_fry_wua = Steelhead Fry wua, ST_juv_wua = Steelhead Juvenile wua") 
