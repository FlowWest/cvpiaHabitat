...
The instream spawning and rearing habitat for Fall Run Chinook Salmon and Steelhead in Battle Creek are based on data from Thomas R. Payne & Associates' instream flow evaluations. The flow evaluations were conducted for the California Department of Fish and Wildlife. They uncovered relationships between flow and suitable spawning and rearing habitat from seven study reaches in Battle Creek. For both species, we consolidated the weighted usable area (WUA) data from all mainstem reaches. The combined data can be found in this spreadsheet (see'~cvpiaHabitat/data-raw/watershed/battle/data/Weighted_composite_Battle.csv).   
