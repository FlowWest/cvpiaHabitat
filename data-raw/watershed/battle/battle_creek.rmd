...
Instream spawning and rearing habitat for Fall Run Chinook Salmon and Steelhead in Battle Creek are based on data from Thomas R. Payne & Associates instream flow evaluations conducted for the California Department of Fish and Wildlife. These evaluations developed relationships between flow and suitable spawning and rearing habitat for Battle Creek from seven study reaches. We used the consolidated WUA for all mainstem reaches for Fall Run Chinook and Steelhead data from Thomas Payne and Associates 1995 located in this spreadsheet (see'~cvpiaHabitat/data-raw/watershed/battle/data/weighted_composite_Battle.csv).   
