...
Instream spawning and rearing habitat for Fall Run Chinook Salmon and Steelhead in the Merced River are based on data from a 2011 and 2012 Merced Irrigation District flow-habitat study in the 19.2 mile-long section of the Merced River from Crocker-Huffman Diversion Dam at river mile (RM) 52.01 downstream to Shaffer Bridge at RM 32.8. Habitat data from this study is summarized on pages 67 - 75 of the MID 2013 study. The instream Fall Run Chinook Salmon spawning and rearing habitat data was provided to us by [Mark Gard](mailto:mark_gard@fws.gov) from the U.S. Fish and Wildlife Service in a spreadsheet (see '~/cvpiaHabitat/data-raw/mark_gard_data/IFIMWUA.xlsx'). Mark Gard instructed us to use A51:D81, A84:D114, and A117:D147 of the 'Merced' tab within his 'IFIMWUA.xlsx'. Steelhead data was also compiled from the Merced Irrigation District 2013 study in a spreadsheet (~/cvpiaHabitat/data-raw/watershed/merced/data/merced-steelhead.csv). The three study reaches for both Fall Run Chinook Salmon and Steelhead were combined and weighted by reach length. 
...
knitr::kable(align = 'c', head(merced_river_instream, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_spawn_wua = Fall Run Chinook Spawning wua, FR_fry_wua = Fall Run Chinook Fry wua, FR_juv_wua = Fall Run Chinook Juvenile wua, ST_spawn_wua = Steelhead Spawning wua, ST_fry_wua = Steelhead Fry wua, ST_juv_wua = Steelhead Juvenile wua, ST_adult_wua = Steelhead Adult wua")
...
knitr::kable(align = 'c', head(merced_river_floodplain, 5), caption = "Header Descriptions: flow_cfs = flow in cubic feet per second, FR_floodplain_acres = Fall Run Chinook floodplain acres, ST_floodplain_acres = Steelhead floodplain acres")
