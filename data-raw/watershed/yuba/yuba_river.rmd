...
**Data Source:**
[SRH-2D hydraulic model developed by Dr. Greg Pasternack at the University of California, Davis](https://s3-us-west-2.amazonaws.com/cvpiahabitat-r-package/cvpia-sit-model-inputs/CVPIA_Annual_Progress_Report_Fiscal_Year_2014_Yuba_SRH2D_Page18.pdf)

`r print_model_details('Yuba River', 'fr')`

## Floodplain Data
```{r, echo= FALSE}
yuba_fp <- read_excel('data-raw/floodplain/CVPIA_FloodplainAreas.xlsx',
                                    sheet = 'YubaRiver') %>%
  mutate(watershed = 'Yuba River',
