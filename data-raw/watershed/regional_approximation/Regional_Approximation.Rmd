...
*Cow Creek has modeled rearing habitat. 
...
### Spawning WUA    
The following plot shows the weighted usable spawning area in square feet per thousand feet of river for un-modeled Upper Sacramento River tributaries Chinook Salmon. These area per length rates are multiplied by the total spawning reach length mapped by the SIT. 
```{r, echo=FALSE}
