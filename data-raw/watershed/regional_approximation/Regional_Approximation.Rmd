...
#### Spawning WUA Plot
The following plot shows the weighted usable spawning area in square feet per thousand feet of river for for un-modeled Upper Sacramento River tributaries Chinook Salmon. These area per length rates are multiplied by the total spawning reach length mapped by the SIT. 
...
The following plot shows the weighted usable rearing area in square feet per thousand feet of river for un-modeled Upper Sacramento River tributaries Chinook Salmon. These rates are multiplied by the total rearing reach length mapped by the SIT. 
