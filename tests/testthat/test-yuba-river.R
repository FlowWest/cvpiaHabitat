...
test_that('ST adult Yuba River works', {
  ...
  adult_not_na_index <- which(!is.na(cvpiaHabitat::yuba_river_instream$ST_adult_wua))[1]
  adult_wua <- cvpiaHabitat::yuba_river_instream$ST_adult_wua[adult_not_na_index]
  ...
  adult_flow <- cvpiaHabitat::yuba_river_instream$flow_cfs[adult_not_na_index]
